...
def test_encode_le_nolen():
    ...
    """
    hex_cmp(encode(0x12345, big_endian=False), from_hex("45 23 01"))
...
def test_encode_le_len():
    ...
    """
    hex_cmp(
        encode(0x12345, big_endian=False, length=4), from_hex("45 23 01 00")
    )
...
def test_encode_le_truncate():
    ...
    """
    hex_cmp(
        encode(0x123456789A, big_endian=False, length=4),
...
def test_encode_be():
    ...
    """
    hex_cmp(encode(0x11223344, big_endian=True), from_hex("11 22 33 44"))
