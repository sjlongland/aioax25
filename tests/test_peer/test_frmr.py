...
from aioax25.frame import AX25Address, AX25Path, \
        AX25FrameRejectFrame, AX25SetAsyncBalancedModeFrame, \
        AX25DisconnectFrame, AX25UnnumberedAcknowledgeFrame, \
        AX25TestFrame
...
def test_on_receive_in_frmr_drop_ua():
    ...
    peer._on_receive(AX25UnnumberedAcknowledgeFrame(
          destination=peer.address,
          source=station.address,
          repeaters=AX25Path('VK4RZB*'),
          cr=False
...
def test_on_receive_in_frmr_pass_disc():
    ...
    peer._on_receive(AX25DisconnectFrame(
          destination=peer.address,
          source=station.address,
          repeaters=AX25Path('VK4RZB*'),
          cr=False
